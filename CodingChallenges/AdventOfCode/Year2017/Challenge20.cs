    ...
    class Particle
    {
        ...
        public Particle(string initLine, int id)
        {
            ...
            foreach (string param in parameters)
            {
                ...
                {
                    case 'p':
                        Position = new ValueTriple(int.Parse(values[0]), int.Parse(values[1]), int.Parse(values[2]));
                        break;
                    case 'v':
                        Velocity = new ValueTriple(int.Parse(values[0]), int.Parse(values[1]), int.Parse(values[2]));
                        break;
                    case 'a':
                        Acceleration = new ValueTriple(int.Parse(values[0]), int.Parse(values[1]), int.Parse(values[2]));
                        break;
                }
            }
            ID = id;

...
namespace CodingChallenges.AdventOfCode.Year2018
{
    ...
    class GuardLog
    {
        ...
        public GuardLog(string input)
        {
            ...
            TimeStamp = DateTime.ParseExact(splittedEntry[1], "yyyy-MM-dd HH:mm", System.Globalization.CultureInfo.InvariantCulture);
            ...
            {
                GuardAction = EGuardAction.eGuardActionFallsAsleep;
            }
            else if (splittedEntry[2].Contains("wakes"))
            {
                GuardAction = EGuardAction.eGuardActionWakesUp;
            }
        }
    }
